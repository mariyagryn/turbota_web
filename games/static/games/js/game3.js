...
function lastmessage() {
    ...
    if (fScore.innerText >= 800) {
        let emoji = "&#128525";
        message.innerHTML = "Неймовірно! Ти справжній математичний геній! " + emoji;
    } else if (fScore.innerText >= 500) {
        let emoji = "&#128531";
        message.innerHTML = "Дуже добре! Ти був(-ла) зовсім близько! " + emoji;
    } else if (fScore.innerText >= 100) {
        let emoji = "&#128549";
        message.innerHTML = "Спробуй ще раз — і все вийде! " + emoji;
    } else {
        let emoji = "&#128577";
        message.innerHTML = "Не засмучуйся, тренуйся ще! " + emoji;
    }
    // Показати рандомну картинку кота
    var catWrap = document.getElementById('cat-image-wrap');
    catWrap.innerHTML = '<img src="https://thecatapi.com/api/images/get?format=src&time=' + Date.now() + '" alt="Random cat" class="cat-img">';
    catWrap.style.display = 'block';
}

// Додаємо стиль для котячої картинки
var style = document.createElement('style');
style.innerHTML = `.cat-img {
  max-width: 80%;
